...
public class DCKGUIPopup
{
    ...
    public DCKGUIPopup(Part part, string module, int ID, int Windowlayer, Rect windowDimensions, string windowName, PopupElement defaultElement)    
    {
    ...
    public DCKGUIPopup(Part part, string module, int ID, int Windowlayer, Rect windowDimensions, string windowName)
    {
        parentPart = part;
        moduleName = module;
        moduleID = ID;
    ...
    public DCKGUIPopup(int Windowlayer, Rect windowDimensions, string windowName)
    {
        GUIlayer = Windowlayer;
        windowRect = windowDimensions;
        windowTitle = windowName;
