...
namespace DCKinc.AAcustomization
{
    public class DCKAAtextureswitch2 : PartModule
    {
        [KSPField]
        ...
        public void useTextureAll(bool calledByPlayer)
        {
            ...
            if (updateSymmetry)
            {
                for (int i = 0; i < part.symmetryCounterparts.Count; i++)
                {
                    ...
                    DCKAAtextureswitch2[] symSwitch = part.symmetryCounterparts[i].GetComponents<DCKAAtextureswitch2>();
